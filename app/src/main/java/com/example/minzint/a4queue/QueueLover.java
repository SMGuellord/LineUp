...
public class QueueLover extends AppCompatActivity  implements  NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_queue_lover);
        ...
        //instantiate drawer.
        drawer = findViewById(R.id.drawer_layoutQueueLover);
        //
        ...
        final ToggleButton btnToggle = findViewById(R.id.toggleButton);
        ...
        // Set onCheckedChangeLister to toggleButton btnToggle.
           ...
           public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
               ...
               request = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                   ...
                   public void onResponse(String response) {
                       ...
                       try {
                           ...
                           if (jsonObject.names().get(0).equals("success")) {
                               ...
                               Toast.makeText(QueueLover.this, jsonObject.getString("success"), Toast.LENGTH_SHORT).show();
                   ...
                   public void onErrorResponse(VolleyError error) {
                       Toast.makeText(QueueLover.this, "Oops!!! Something went wrong. Server must be offline", Toast.LENGTH_SHORT).show();
                   }
               }) {
